...
* Test Steps
  ...
  5. Enter invalid rim sherd diameter value in the diameter box.
  6. and click on Next button

* Expected result
  1. Simulation page should be opened
  2. Content should be present with no distortions and Junk characters
  3. A page should be opened with the simulation process
  4. An error message should be displayed on the screen as to enter the valid diameter value
